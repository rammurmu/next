  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <div className={styles.description}>{' '}<card className={styles.card}><code className={styles.code}><p className={styles.paragraph}>👏 Welcome to RunAsh &rarr;</p></code></card></div>
        ...
        <h1 className={styles.title}> 
          Future of<br /><a href="https://">eCommerce</a>
        </h1>
        <p className={styles.description}>
