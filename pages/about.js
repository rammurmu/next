  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.title}>
        ...
        <h2 className={styles.description}>🤔 Oneliner</h2>
          <p className={styles.description}>A live streaming hybrid marketplace for retailing<br />Learn more &rarr;</p>
        
        
         <h2 className={styles.description}>🎓 Discipline,learning & culture</h2>
        ...
        <h2 className={styles.description}>🎥 What we going to make</h2>
         ...
         <h1 className={styles.description}>👨‍💻 Executive profile</h2>
          <P className={styles.description}>Board of Directors<br />Ram Murmu andVaibhav Murmu<br /> Learn more &rarr;</p>
