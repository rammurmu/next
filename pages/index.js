  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <div className={styles.description}>{' '}<card className={styles.card}><code className={styles.code}>👏 Welcome to RunAsh &rarr;</card></code></div>
        ...
        <h1 className={styles.title}> 
          The future of<br /><a href="https://">eCommerce</a>
        </h1>
        <p className={styles.description}>
