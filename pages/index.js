  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <div className={styles.cards}><code className={styles.code}>New</code><b>Updates:</b> Introducing the next generation and future of live-retail streaming &rarr;</div>
