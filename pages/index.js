  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <div className={styles.cards}><b><code className={styles.code}>New</code>Updates:</b> Introducing the next generation and future of live-retail streaming &rarr;</div>
